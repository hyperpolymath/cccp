...
git clone <https://github.com/hyperpolymath/cccp.git> cd cccp
...
toolbox create cccp-dev toolbox enter cccp-dev \# Install dependencies
manually
...
cccp/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library code
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/cccp/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/cccp/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/cccp/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/cccp/labels/perimeter-3) — Community sandbox scope
