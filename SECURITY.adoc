...
[arabic]
. Navigate to
https://github.com/hyperpolymath/cccp/security/advisories/new[Report a
Vulnerability]
...
https://github.com/hyperpolymath/cccp/security/advisories[Security
Advisories]
...
|Purpose |Contact
|*Security issues*
|https://github.com/hyperpolymath/cccp/security/advisories/new[Report
via GitHub] or 6759885+hyperpolymath@users.noreply.github.com

|*General questions*
|https://github.com/hyperpolymath/cccp/discussions[GitHub Discussions]
...
_Thank you for helping keep Cccp and its users safe._ 🛡️
