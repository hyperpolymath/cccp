...
Replace all {{PLACEHOLDER}} values with your information:
  Cccp     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  cccp             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/cccp/security/advisories/new)
...
- This repository (`hyperpolymath/cccp`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/cccp/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/cccp/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/cccp/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/cccp/discussions) |
...
*Thank you for helping keep Cccp and its users safe.* 🛡️
