...
* *AffineScript* — OCaml soundness, compiles to JS
...
| AffineScript, Rust, Deno, Gleam, OCaml, Ada, Julia, Guile Scheme, Nickel
...
1. *Tauri 2.0+* — Web UI (AffineScript) + Rust backend, MPL-2.0/MPL-2.0
...
2. *Short-term*: Convert TypeScript to AffineScript
...
* *Self-Sufficient* — Guix + Podman + SaltRover = complete autonomy
