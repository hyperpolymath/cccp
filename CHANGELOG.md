...
All notable changes to `cccp` will be documented in this file.
...
- feat: add language satellites (nextgen-languages, sanctify-php, php-aegis)
...
- fix(ci): repair YAML block-scalar in workflow-linter Check Permissions step (#5)
